...
<ul id="admin_list" class="nav nav-list">
  ...
  <li class="active"><a href="#" class="adminnav" link="${mainpath}/admin/pic">首页图片</a></li>
  <li><a href="#" class="adminnav" link="${mainpath}/admin/order">订单管理</a></li>
  <li><a href="#" class="adminnav" link="${mainpath}/admin/news">新闻发布</a></li>
</ul>
</div>
<div class="span10">
<iframe id="admin_frame" src="about:blank" style="width:100%;height:500px;border:0px;padding:0px;margin:0px;" frameborder="0">
</iframe>
