...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [["fullscreen","source","insertcode","fontfamily","fontsize","undo","redo","insertunorderedlist","insertorderedlist","link","unlink","cleardoc","selectall","print","preview","searchreplace","gmap","pagebreak","insertimage","scrawl","music","snapscreen","emotion","insertvideo","attachment","insertframe","date","time","wordimage","map","horizontal","anchor","spechars","blockquote","background","bold","italic","underline","strikethrough","forecolor","backcolor","superscript","subscript","justifyleft","justifycenter","justifyright","justifyjustify","directionalityltr","directionalityrtl","indent","formatmatch","removeformat","autotypeset","rowspacingbottom","rowspacingtop","lineheight","inserttable","mergeright","mergedown","splittorows","splittocols","splittocells","mergecells","insertcol","insertrow","deletecol","deleterow","insertparagraphbeforetable","help"],[]]
